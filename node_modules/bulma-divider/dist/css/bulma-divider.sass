...
.is-divider[data-content]::after, .is-divider-vertical[data-content]::after
  ...
  margin: .4rem .8rem
  -webkit-transform: translateY(-$divider-font-size - $divider-thickness)
  -ms-transform: translateY(-$divider-font-size - $divider-thickness)
  transform: translateY(-$divider-font-size - $divider-thickness)
  text-align: center
